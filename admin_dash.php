...
?>
       ...
       <div class="container-fluid">
        <table class="tab">
            <tr class="text-center">
                <th class="text-opacity-75" colspan="3">Products Categories</th>
            </tr>
            <tr>
                <th class="text-black">Category</th>
                <th class="text-black">Insert</th>
                <th class="text-black">Edit</th>
            </tr>
            <tr>
                <td>Baby clothes</td>
                <td>
                    <a href="b_c_insert.php"><button class="">Insert</button></a>
                </td>
                 <td>
                    <a href="b_c_view.php"><button class="">Edit</button></a>
                </td>
            </tr>
             <tr>
                <td>Childrens wear</td>
                <td>
                    <a href="c_c_insert.php"><button class="">Insert</button></a>
                </td>
                 <td>
                   <a href="c_c_view.php"><button class="">Edit</button></a>
                </td>
            </tr>
             <tr>
                <td>Menswear</td>
                <td>
                    <a href="m_c_insert.php"><button class="">Insert</button></a>
                </td>
                 <td>
                   <a href="m_c_view.php"><button class="">Edit</button></a>
                </td>
            </tr>
            <tr>
                <td>Womenswear</td>
                <td>
                    <a href="w_c_insert.php"><button class="">Insert</button></a>
                </td>
                 <td>
                   <a href="w_c_view.php"><button class="">Edit</button></a>
                </td>
            </tr>
        </table>
       </div>
       <div class="container-fluid">
         <table border="2px" class="tab">
            <tr>
                <th class="text-black">Customers</th>
                <th class="text-black">Action</th>
            </tr>
            <tr>
                <td>customers</td>
                 <td>
                    <a href="cust_del.php"><button class="">Action</button></a>
                </td>
            </tr>
       </div>
</body>

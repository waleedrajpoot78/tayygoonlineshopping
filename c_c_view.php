...
?>
       ...
       <div class="container mb-5">
        <div class="form-signin con bg-light">
            <form method="post" action="c_c_insert.php" enctype="multipart/form-data">
...
?></html>
 ...
 $sql="select product.p_id,categories.c_name,product.p_name,product.p_desc,product.size,product.p_price,product.image from product INNER JOIN categories on product.c_id = categories.c_id where product.c_id=2 AND (product.c_id is NOT null and categories.c_id IS NOT null)";

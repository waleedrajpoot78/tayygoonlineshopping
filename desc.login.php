    ...
    <nav class="navbar sticky-top navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid w-100 ml-lg-5">
          ...
          <div class="navbar-nav button d-flex flex-row-reverse">
            <a class="mr-3" href="login.html"><button class="loginbtn"><i class="fa fa-user"></i> Login</button></a>
      ...
      <div class="py-5">
          ...
          ?>
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="./image/<?php echo $row['image']; ?>" alt="1" /></div>
                    <div class="col-md-6">

<?php
    ...
    $sql = "select * from admin where Email = '$b' and Password = '$c'";  
        ...
        <div class="form-signin bg-light">
            <form method="post">
                ...
                <div class="w-100 text-center">
                    <input type="submit" name="admin" class="w-75 btn btn-lg btn-dark" value="Login" type="submit">
                <br>
                <a href="login.html">
                <button class="w-75 mt-3 btn btn-lg btn-dark" type="button">Customer Login</button></a>
            </div>
                </div>
            </form>
        </div>
